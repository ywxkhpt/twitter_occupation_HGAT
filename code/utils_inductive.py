...
def transform_dataset_by_idx(adj_list, feature_list, related_idx, trans_idx):
    related_nodes = get_related_nodes(adj_list, related_idx, 1)
    ...
    return adj_list_new, feature_list_new, output_idx
